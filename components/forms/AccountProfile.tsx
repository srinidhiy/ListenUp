...
Onboarding form to enter user details
...
// these come from if a user signs in through google
interface Props {
    user: {
        id: string;
        objectId: string;
...
const AccountProfile = ({ user, btnTitle }: Props) => {
    ...
    // makes sure image upload works - fieldChange is part of the react-hook-form hook to update the field in frontend
